...
lookupUpdatehandler(value){    
    ...
    console.log("sobject---" + this.sObjectApiName + typeof(this.sObjectApiName));

  var sobjname = this.sObjectApiName;
    const oEvent = new CustomEvent('lookupupdate',
    {
        'detail': {selectedRecord: value,typeofobj:sobjname}
        // 'rectype':{key1:this.sObjectApiName}
    }
);
